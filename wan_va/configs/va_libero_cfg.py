...
import os as _os
va_libero_cfg.wan22_pretrained_model_name_or_path = _os.environ.get(
    "WAN22_PRETRAINED_PATH",
    _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "..", "..", "checkpoints", "libero")
)
