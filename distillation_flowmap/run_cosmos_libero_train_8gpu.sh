...
COSMOS_MIXED_STEP_SELECTOR_SEED="${COSMOS_MIXED_STEP_SELECTOR_SEED-}"
COSMOS_MIXED_STEP_FORCE_SEQUENCE="${COSMOS_MIXED_STEP_FORCE_SEQUENCE-}"
COSMOS_MIXED_STEP_METRICS_PATH="${COSMOS_MIXED_STEP_METRICS_PATH-}"
COSMOS_MIXED_STEP_DANCE_QUERY_METRICS_PATH="${COSMOS_MIXED_STEP_DANCE_QUERY_METRICS_PATH-}"
export COSMOS_MIXED_STEP_POLICY COSMOS_MIXED_STEP_SELECTOR_SEED
export COSMOS_MIXED_STEP_FORCE_SEQUENCE COSMOS_MIXED_STEP_METRICS_PATH
export COSMOS_MIXED_STEP_DANCE_QUERY_METRICS_PATH
...
ALIGNED_VIDEO_OPD_INTERVAL="${ALIGNED_VIDEO_OPD_INTERVAL:-4}"
ACTION_DOWNSAMPLE_FACTOR="${ACTION_DOWNSAMPLE_FACTOR:-4}"
VIDEO_ACTION_BRIDGE="${VIDEO_ACTION_BRIDGE:-0}"
[[ "$ALIGNED_VIDEO_OPD_INTERVAL" == "4" ]] || die \
    "ALIGNED_VIDEO_OPD_INTERVAL is fixed at 4 for the aligned Stage-2 protocol"
[[ "$ACTION_DOWNSAMPLE_FACTOR" == "4" ]] || die \
    "ACTION_DOWNSAMPLE_FACTOR is fixed at the audited packing factor 4"
[[ "$VIDEO_ACTION_BRIDGE" == "0" ]] || die \
    "VIDEO_ACTION_BRIDGE is disabled for the audited aligned Stage-2 protocol"
export ALIGNED_VIDEO_OPD_INTERVAL ACTION_DOWNSAMPLE_FACTOR VIDEO_ACTION_BRIDGE
...
export LD_LIBRARY_PATH="${COSMOS_WORKER_CUDA_LIBRARY_PATH}"
...
for key in \
    ...
    COSMOS_MIXED_STEP_POLICY COSMOS_MIXED_STEP_SELECTOR_SEED \
    COSMOS_MIXED_STEP_FORCE_SEQUENCE COSMOS_MIXED_STEP_METRICS_PATH \
    ...
    ALIGNED_VIDEO_OPD_INTERVAL ACTION_DOWNSAMPLE_FACTOR VIDEO_ACTION_BRIDGE \
    ...
    COSMOS_POLICY_EXTRA_PYTHONPATH COSMOS_WORKER_CUDA_LIBRARY_PATH LD_LIBRARY_PATH \
    ATTN_MODE \
