...
PINNED_OPERATIONAL_ENV = frozenset(
    {
        ...
        "COSMOS_MIXED_STEP_FORCE_SEQUENCE",
        "COSMOS_MIXED_STEP_METRICS_PATH",
        "COSMOS_MIXED_STEP_POLICY",
...
PINNED_ENV_EXPECTED_VALUES: Mapping[str, tuple[str, str]] = {
    "ALIGNED_VIDEO_OPD_INTERVAL": ("literal", "4"),
    ...
    "OPD_DANCEOPD_ANCHOR_TEACHER_STEPS": ("literal", "8"),
...
COSMOS_MIXED_STEP_DANCE_QUERY_METRICS_PATH COSMOS_MIXED_STEP_FORCE_SEQUENCE
COSMOS_MIXED_STEP_METRICS_PATH COSMOS_MIXED_STEP_POLICY
COSMOS_MIXED_STEP_SELECTOR_SEED
...
VIDEO_ACTION_BRIDGE VIDEO_TRANSITION_WEIGHT WANDB_MODE WARMUP_STEPS
""".split()
)
