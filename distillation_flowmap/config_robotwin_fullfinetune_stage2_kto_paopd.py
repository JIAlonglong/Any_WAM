"""Stage 2 KTO-PAOPD normalized focal reweighting variant for RobotWin."""
import copy
import os

from distillation_flowmap.config_robotwin_fullfinetune_stage2_anyflow import cfg as _base_cfg
...
cfg.output_dir = os.environ.get(
    "OUTPUT_DIR",
    os.path.join(_this_dir, "output_robotwin_fullft_stage2_kto_paopd_norm_focal"),
)
cfg.wandb_name_prefix = os.environ.get(
    "WANDB_NAME_PREFIX",
    "robotwin_stage2_fullft_kto_paopd_norm_focal",
)
