...
def compute_mechanism_metric_samples(
    *,
    ...
    anchor_mse = mse_per_sample(teacher_cont_video, teacher_endpoint_video)
    comp = squared_l2_per_sample(student_direct_video, student_composed_video)
    comp_mse = mse_per_sample(student_direct_video, student_composed_video)
