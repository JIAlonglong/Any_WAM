import numpy as np
import sys, os
# Add the Simple_Remote_Infer parent to path so we can import the deploy
# package without triggering wan_va/__init__.py (which pulls in diffusers).
_sri_dir = os.path.join(os.path.dirname(__file__), "..", "..", "wan_va", "utils", "Simple_Remote_Infer")
_sri_dir = os.path.abspath(_sri_dir)
