...
def test_mixed_cosmos_danceopd_never_appends_an_exact_zero_teacher_query():
    ...
    post_update_block = velocity_loss_block.split("query_indices =")[0]
...
class DanceOPDQueryTest(unittest.TestCase):
    ...
    def test_cosmos_danceopd_syncs_configured_rollout_choices(self):
        ...
        self.assertIn("effective_rollout_steps = rollout_step_choices[", cosmos_block)
        self.assertIn("choice_index.item()", cosmos_block)
